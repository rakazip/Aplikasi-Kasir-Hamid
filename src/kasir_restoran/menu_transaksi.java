...
public class menu_transaksi extends javax.swing.JFrame {
    ...
    class transaksi extends menu_transaksi{
        ...
        public transaksi() {
            ...
            try {
                Date date = text_tanggal.setDate();
    ...
    private void initComponents() {
        ...
        text_id_transaksi.setBackground(new java.awt.Color(204, 204, 255));
        ...
        text_nama_pelanggan.setBackground(new java.awt.Color(204, 204, 255));
        ...
        combo_id_masakan.setBackground(new java.awt.Color(204, 204, 255));
        ...
        btn_cetak_laporan.setBackground(new java.awt.Color(102, 255, 255));
        ...
        btn_logout.setBackground(new java.awt.Color(102, 255, 255));
        ...
        text_jumlah_beli.setBackground(new java.awt.Color(204, 204, 255));
        text_jumlah_beli.setFont(new java.awt.Font("Consolas", 1, 24)); // NOI18N

        btn_menu_masakan.setBackground(new java.awt.Color(102, 255, 255));
        ...
        text_total_bayar.setBackground(new java.awt.Color(204, 204, 255));
        text_total_bayar.setFont(new java.awt.Font("Consolas", 1, 24)); // NOI18N
        text_total_bayar.setEnabled(false);

        text_tanggal.setBackground(new java.awt.Color(204, 204, 255));
